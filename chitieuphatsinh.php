    ...
    <?php include('inc/menu.php')?>
        <div id="layoutSidenav_content">
            <main>
                ...
                ?>
                    <h1 class="mt-4">Danh sách chi tiêu phát sinh <span style="font-size : 60%"> (Tổng tiền : <?php echo number_format($artinhtt['tongtien']) ?> VND) </span></h1>
                    <div class="card mb-4">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Chi tiêu phát sinh : <?php echo $arUser["ten"] ?>
                                                            <form action="function.php" method="post">
                                                                ...
                                                                <div class="modal-footer" style="margin-top: 20px">
                                                                    ...
                                                                    <button style="width:100px" type="submit" class="btn btn-danger" name="xoactps"> Xóa</button>
